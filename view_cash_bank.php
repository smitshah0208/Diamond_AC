...
<head>
    ...
    <style>
        .filter-box { background: #f8fafc; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0; margin-bottom: 25px; }
        ...
        .filter-field label { display: block; font-size: 13px; font-weight: 600; color: #64748b; margin-bottom: 5px; }
        .search-btn { background: #0f172a; color: white; border: none; padding: 12px 25px; border-radius: 6px; cursor: pointer; font-weight: 500; }
        .search-btn:hover { background: #334155; }
        
        .totals-row { background: #f1f5f9; font-weight: bold; font-size: 15px; }
...
<div class="container" style="max-width: 1200px;">
    ...
    <table id="resultsTable">
        ...
        <tbody>
            <tr><td colspan="6" class="empty-row">Select filters and click Search.</td></tr>
        </tbody>
        <tfoot>
            <tr class="totals-row">
